...
ERW.route(ReportsRoute, 'post', '/:projectName/:projectVersion/:reportName/:processorType', async (req, res) => {
  const reportFolder = `${Config.REPORT_DIR}/${req.params.projectName}_${req.params.projectVersion}_${
